...
@Component({
  selector: 'app-purchase-orders-authorizer-form',
  templateUrl: './purchase-orders-authorizer-form.component.html',
  styleUrls: ['./purchase-orders-authorizer-form.component.scss']
})
export class PurchaseOrdersAuthorizerFormComponent implements OnInit {
