...
@Component({
  selector: 'app-authorization-sales-report-form',
  templateUrl: './authorization-sales-report-form.component.html',
  styleUrls: ['./authorization-sales-report-form.component.scss']
})
export class AuthorizationSalesReportFormComponent implements OnInit {
